...
export default function App() {
  ...
  return (
    <main>
      ...
      <h1>BountyBot</h1>
      <p className="tag">
        Trustless GitHub bounties on GenLayer. The Intelligent Contract fetches the issue,
        the PR, and the raw diff directly from github.com on-chain, and validator LLMs vote
        together on whether the PR actually fixes the issue — no maintainer approval needed.
      </p>
